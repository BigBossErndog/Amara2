namespace Amara {
    class TextureLayer: public Amara::TextureContainer {
    public:
        bool resolutionLocked = true;
        Vector2 render_scale = Vector2(1, 1);

        TextureLayer(): Amara::TextureContainer() {
            set_base_node_id("TextureLayer");
        }
