...
# WINDOWS_COMPILER_FLAGS = -w -Wall -m64 -std=c++17 -Wl,/NOIMPLIB -DAMARA_DEBUGGING
...
SDL_PATH = $(RESOURCES)/libs/SDL3-3.4.10
SDL_INCLUDE_PATHS_WIN64 = -I$(SDL_PATH)/include
SDL_LIBRARY_PATHS_WIN64 = -L$(SDL_PATH)/lib/x64
...
EXTRA_OPTIONS = -DAMARA_DEBUGGING -DAMARA_PLUGINS -DAMARA_ENGINE_TOOLS
